...
<body>
  ...
  <form action="assets/html/login_check.php" method="post" class="login-container" id="loginContainer">
    <h2>Admin Login</h2>
    <input type="text" id="phone" placeholder="Phone" name="phone" />
    <input type="password" id="password" placeholder="Password" name="password"/>
    
    <!-- Initially hidden alert box -->
    <div class="alert">
  ...
  <script>
    ...
    if (window.location.href.split("?")[1] !== undefined) {
      ...
      const params = new URLSearchParams(queryString);  // Easier way to handle query parameters

      const message = params.get("error");  // Example: ?message=error

      // Display the alert message if there's a message parameter
      if (message) {
        ...
        document.getElementsByClassName("alert")[0].style.display = 'block';  // Show the alert
      }
    }
  </script>
